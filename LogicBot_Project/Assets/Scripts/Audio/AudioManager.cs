...
public class AudioManager : MonoBehaviour
{
	...
	[SerializeField] private FloatGameEvent _SFXVolumeGameEvent = default;
	[Tooltip("The SoundManager listens to this event, fired by objects in any scene, to change Music volume")]
	[SerializeField] private FloatGameEvent _musicVolumeGameEvent = default;
	[Tooltip("The SoundManager listens to this event, fired by objects in any scene, to change Master volume")]
	[SerializeField] private FloatGameEvent _masterVolumeGameEvent = default;
	...
	private void OnEnable()
	{
		...
		_masterVolumeGameEvent.AddListener(ChangeMasterVolume);
		_musicVolumeGameEvent.AddListener(ChangeMusicVolume); 
		_SFXVolumeGameEvent.AddListener(ChangeSFXVolume);
	...
	private void OnDestroy()
	{
		...
		_musicVolumeGameEvent.RemoveListener(ChangeMusicVolume);
		_SFXVolumeGameEvent.RemoveListener(ChangeSFXVolume);
		_masterVolumeGameEvent.RemoveListener(ChangeMasterVolume);
	}
