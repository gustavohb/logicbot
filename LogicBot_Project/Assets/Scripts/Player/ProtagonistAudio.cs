...
{
    [SerializeField] private AudioCueSO jump, footstep, turnLightOn, changeColor;
    ...
    public void PlayChangeColor() => PlayAudio(changeColor, _audioConfig, transform.position);
}
